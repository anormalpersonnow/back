...
topicRouter.get("/:id", postController.getPostById)
topicRouter.get("/content", postController.getPostsByContent)
topicRouter.get("/user/:userId", postController.getUserPosts)
